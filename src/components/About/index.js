        ...
        <div>
            <div className="container about-page">
                <div className="text-zone">
                    ...
                    <p>I'm a greatly ambitious front-end developer, seeking for a role in established software company with the opportunity to work with the
                        technologies on challenging and diverse projects.</p>
                    <p align="LEFT">            I'm quietly confident, naturally curious, and perpetually working on
                        improving my chops one design problem at a time.</p>
                    <p> I'd say that would be a fan of work-life balance, travelling enthusiast and tech-obsessed.</p>
